    ...
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <div className="flex justify-between items-center p-4 transition-colors duration-300">
        ...
        >
          ...
          ></div>
          <div
            className={`absolute w-5 h-5 rounded-full bg-white shadow-lg transform transition-transform duration-300 ${
              darkMode ? 'translate-x-1' : 'translate-x-8'
            } top-1`}
          ></div>
        </button>
      ...
      <div className="max-w-xl mx-auto mt-16 px-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className={`mb-8 w-full py-2.5 rounded-lg font-medium transition-colors duration-300 ${
              darkMode ? 'bg-purple-600 text-white hover:bg-purple-700' : 'bg-blue-600 text-white hover:bg-blue-700'
            }`}
          >
            Submit Report
          </button>
